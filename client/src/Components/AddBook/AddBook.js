...
function AddBook(props) {
  ...
  const rules = `    Правила публикации
  Основные положения
  ...
  return (
    <div className='background  flex_center'>
      <div className="wrapper-white">
        ...
        <form className='formAddBook modal_form' encType="multipart/form-data" method="post" action="/testupl" onSubmit={(e) => saveFile(e)}>
          ...
          <div className="flex_center add-book_add-file wide-input">
            ...
            <input type="button" className="file_input input mb-1 color-light" id="loadFileImg" value="img" onClick={pickImg} />
          </div>
          ...
          <div className="flex_center add-book_add-file wide-input">
            ...
            <input type="button" className="file_input input mb-1 color-light" id="loadFilePdf" value=".pdf" onClick={pickFile} />
          </div>
      ...
      <div className="popup flex_center flex_column">
        ...
        <textarea readOnly className="textarea" value={rules}>
        </textarea>
